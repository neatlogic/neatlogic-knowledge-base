 ...
 **/
public class KnowledgeDocumentLineHandlerNotFoundException extends ApiRuntimeException {

    private static final long serialVersionUID = 1669102356313895840L;

    public KnowledgeDocumentLineHandlerNotFoundException(String handler) {
